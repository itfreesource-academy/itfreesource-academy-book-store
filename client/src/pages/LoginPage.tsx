  ...
  return (
    <div className="space-y-6 pb-20 max-w-4xl mx-auto" data-testid="login-page">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 bg-slate-900/90 p-8 sm:p-10 rounded-3xl border border-slate-800 shadow-2xl backdrop-blur-xl">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-xl font-extrabold text-white leading-tight" data-testid="login-heading">
                Welcome Back
              </h1>
          ...
          <form onSubmit={handleStandardLogin} className="space-y-4 text-xs" data-testid="login-form">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-slate-700 bg-slate-950 rounded-xl focus:ring-2 focus:ring-indigo-500 font-semibold text-white placeholder-slate-500 transition-all text-sm"
                required
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full pl-4 pr-11 py-3 border border-slate-700 bg-slate-950 rounded-xl focus:ring-2 focus:ring-indigo-500 font-semibold text-white placeholder-slate-500 transition-all text-sm"
                  required
                />
                <button
                  type="button"
            ...
            <button
              ...
              className="w-full mt-3 py-3.5 px-5 bg-indigo-600 hover:bg-indigo-500 text-white font-extrabold text-sm rounded-xl shadow-lg shadow-indigo-500/30 hover:shadow-indigo-500/40 transition-all flex items-center justify-center gap-2 disabled:opacity-50 cursor-pointer"
            >
          ...
          {isAuthenticated && user && (
            <div className="mt-6 p-4 rounded-2xl bg-indigo-950/50 border border-indigo-800/80 flex items-center justify-between text-xs">
              <div>
                <span className="text-slate-400 block text-[11px]">Currently signed in as:</span>
        ...
        <div className="lg:col-span-5 space-y-4">
          <div className="bg-slate-900/90 p-6 sm:p-7 rounded-3xl border border-slate-800 shadow-2xl backdrop-blur-xl">
            ...
            <div className="space-y-3">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 border border-slate-700 rounded-xl bg-slate-950 focus:ring-2 focus:ring-indigo-500 font-bold text-xs text-white cursor-pointer"
              ...
              {currentPersona && (
                <div className="p-4 rounded-2xl bg-slate-950/70 border border-slate-800 space-y-2.5 text-xs">
                  ...
                  <div className="pt-2 border-t border-slate-800 flex items-center justify-between text-[10px] text-slate-400">
                    <span>
                      Password: <code className="font-mono font-bold text-indigo-300 bg-slate-900 px-1 py-0.5 rounded border border-slate-800">{PERSONA_PASSWORDS[currentPersona.username]}</code>
                    </span>
              ...
              <button
                ...
                disabled={isSubmitting}
                className="w-full py-2.5 px-4 bg-slate-800 hover:bg-indigo-950/60 text-slate-200 hover:text-indigo-300 border border-slate-700 hover:border-indigo-700 rounded-xl font-bold text-xs transition-all flex items-center justify-center gap-2 cursor-pointer"
          ...
          <div className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800 text-slate-400 text-xs flex items-start gap-2.5">
            ...
            <span className="text-[11px] leading-relaxed">
              In QA automation suites (Playwright, Cypress, Postman), use standard POST <code className="font-mono text-indigo-300 font-bold">/api/v1/auth/login</code> with any of these personas.
            </span>
          </div>
        </div>
      </div>
