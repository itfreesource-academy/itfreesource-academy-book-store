  ...
  return (
    <div className="space-y-10 pb-20" data-testid="about-page">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-3">
            ...
            <h3 className="text-sm font-bold text-slate-900">E2E UI & API Test Automation</h3>
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-3">
            ...
            <h3 className="text-sm font-bold text-slate-900">RBAC Security & 11 Personas</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-3">
            ...
            <h3 className="text-sm font-bold text-slate-900">Microservices Chaos & Latency</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-3">
            ...
            <h3 className="text-sm font-bold text-slate-900">Multi-Tier Pricing & Marketplaces</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-3">
            ...
            <h3 className="text-sm font-bold text-slate-900">Dual-Mode Buy vs. Rent Engine</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-3">
            ...
            <h3 className="text-sm font-bold text-slate-900">CI/CD & Live Edge Previews</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
      ...
      <div className="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm space-y-4">
        ...
        <div className="bg-slate-50 rounded-2xl p-5 border border-slate-200 text-xs text-slate-700 space-y-3">
          ...
          <ol className="list-decimal list-inside space-y-2 text-slate-800 font-medium">
            <li>
              <strong>The Production URL</strong>: <code className="bg-slate-200 px-1.5 py-0.5 rounded font-mono font-bold text-indigo-700">https://bookstore.itfreesource.workers.dev</code> is the canonical live production system.
            </li>
            <li>
              <strong>Your Isolated Feature Environment</strong>: When you create a branch (e.g. <code className="bg-slate-200 px-1.5 py-0.5 rounded font-mono">newFeature</code>) and push to the repository, Cloudflare automatically deploys your branch to:
              <div className="my-1.5 p-2 bg-indigo-100/70 border border-indigo-200 rounded-lg font-mono font-bold text-indigo-900">
      ...
      <div className="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm space-y-6">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs text-slate-600" data-testid="about-personas-table">
            ...
            <tbody className="divide-y divide-slate-100">
              {TEST_PERSONAS.map((p) => {
                ...
                return (
                  <tr key={p.username} className="hover:bg-slate-50/70 transition-colors">
                    ...
                    <td className="py-3 px-4">
                      <span className="font-mono bg-slate-100 px-2 py-1 rounded text-slate-700 flex items-center gap-1 max-w-fit">
                    ...
                    <td className="py-3 px-4 text-right">
                      <button
                        ...
                        className="inline-flex items-center gap-1 px-2.5 py-1 bg-indigo-50 hover:bg-indigo-600 text-indigo-700 hover:text-white rounded-lg text-xs font-bold transition-colors"
