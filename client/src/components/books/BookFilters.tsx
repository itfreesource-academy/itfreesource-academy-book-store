...
export const BookFilters: React.FC<BookFiltersProps> = ({
  ...
  return (
    <div
      ...
      className="bg-slate-900/90 rounded-2xl border border-slate-800 p-5 space-y-6 shadow-xl shadow-black/30 text-slate-200"
    >
      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 text-xs bg-slate-950 border border-slate-700 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
          />
        </div>
      </div>
      ...
      <div className="pt-2 border-t border-slate-800">
        <label
          ...
          className="flex items-center gap-2 cursor-pointer text-xs font-medium text-slate-300 hover:text-white"
        >
          <input
            type="checkbox"
            checked={vipOnly}
