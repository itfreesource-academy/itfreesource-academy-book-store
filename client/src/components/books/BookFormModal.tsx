      ...
      <form onSubmit={handleSubmit} className="space-y-4 text-xs" data-testid="book-form">
        ...
        <div>
          ...
          <div className="flex gap-2">
            ...
            <label
              ...
              className="cursor-pointer flex items-center gap-1.5 px-3 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg border border-slate-300 font-semibold"
            >
        ...
        <div>
          <div className="flex justify-between items-center mb-1">
            ...
            <span className="text-[10px] text-slate-400" data-testid="desc-char-count">
          ...
          <textarea
            ...
            className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-500 text-xs"
          />
        </div>
